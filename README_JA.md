...
| メインUI | ホスト管理 | タスク管理 |
|---------|-----------|-----------|
| ![メインUI](build/bin/性能测试软件.png) | ![ホスト管理](build/bin/主机管理.png) | ![タスク管理](build/bin/任务管理.png) |

| スクリプト設定 | レポート (1) | レポート (2) |
|---------------|------------|------------|
| ![スクリプト設定](build/bin/配置模型.png) | ![レポート1](build/bin/分析报告1.png) | ![レポート2](build/bin/分析报告2.png) |
