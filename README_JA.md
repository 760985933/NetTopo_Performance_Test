...
| メインUI | ホスト管理 | タスク管理 |
|---------|-----------|-----------|
| ![メインUI](imgs/main-ui.png) | ![ホスト管理](imgs/host-management.png) | ![タスク管理](imgs/task-management.png) |

| スクリプト設定 | レポート (1) | レポート (2) |
|---------------|------------|------------|
| ![スクリプト設定](imgs/script-config.png) | ![レポート1](imgs/report-1.png) | ![レポート2](imgs/report-2.png) |
